...
/*
 * this class consists of scatter chart and image view, so data can be displayed on top of an image.
 * the image position and size can be adjusted so the tracking data can be displayed in relation to it.
