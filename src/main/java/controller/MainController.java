...
public class MainController implements Controller {
	...
	private void loadView(String name) throws IOException {
		...
		loader.setLocation(getClass().getResource("/view/"+name+".fxml"));
	...
	private void openMeasurementView() throws IOException{
		...
		measurementController.setTrackingDataController(trackingDataController);
	}
	...
	private void openThrombectomyView() throws IOException {
		...
		thrombectomyController.setTrackingDataController(trackingDataController);
	};
