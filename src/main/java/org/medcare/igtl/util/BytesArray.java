...
public class BytesArray {
    ...
    public String getString(int len) {
        if (bytesArray == null) {
            ...
            try {
                ...
                ByteBuffer bb = StandardCharsets.US_ASCII.encode(
                        CharBuffer
     ...
     * **
     *
     * @param buf The bytes to callculate the crc from
     *            ** @param len
     ...
     * **
     *
     * @param t the time in millis from 00:00:00 January 1, 1970, UTC value
     ...
     * **
     *
     * @param s the seconds from time in millis from 00:00:00 January 1, 1970,
     *          UTC value
     * @param f the fraction of time in millis from 00:00:00 January 1, 1970,
     *          UTC value
     *          ** @return The byte array containing the timestamp
     */
     ...
     * **
     *
     * @param array the array to decode TimeStamp from
     *              <p>
     ...
     * byte is signed.
     *
     * @param b the byte to get short from
     *          <p>
     ...
     * **
     *
     * @param buffer The bytes to callculate the crc from
     *               ** @param len
