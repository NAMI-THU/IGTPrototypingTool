...
public class DataProcessor {
	 ...
	 *            - value of type AverageMeasurement
	 ...
	 * 
	 * @param errors
	 *            - a list with errors of type double
	 ...
	 * 
	 * @param measurements
	 *            - list of type measurements
	 * @param avgRotation
	 *            - average rotation of type Quaternion
